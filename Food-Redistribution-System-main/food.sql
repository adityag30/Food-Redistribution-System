...
CREATE TABLE User (
    ...
    username VARCHAR(50) UNIQUE NOT NULL,a
...
UPDATE User
SET password_hash = SHA2('newpassword123', 256)
...
SELECT * FROM  DonationStatistics;
...
SHOW TRIGGERS LIKE 'enforce_admin_user_role';
DELIMITER $$
...
DELIMITER ;
SHOW TRIGGERS LIKE 'Alert_Donation_Status';
...
SHOW TRIGGERS LIKE 'Notify_Expiration_Alert';
DELIMITER $$
...
DELIMITER ;
SHOW TRIGGERS LIKE 'LogUserLogin';
...
DELIMITER ;
SHOW TRIGGERS LIKE 'LogDonationAction';
...
DELIMITER ;
SHOW TRIGGERS LIKE 'LogNotificationAction';
