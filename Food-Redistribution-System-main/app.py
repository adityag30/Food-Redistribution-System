...
app.secret_key = "1234"  # Replace with a secure random key
...
def get_db_connection():
    try:
        connection = mysql.connector.connect(
            ...
            password=os.getenv("MYSQL_PASSWORD", "P@ssWord000"),
            database=os.getenv("MYSQL_DATABASE" , "fooddonationdb")
        )  # Can be None if DB not created
